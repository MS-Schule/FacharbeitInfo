...
public static class MnistReader
{
    ...
    private const string TestImages = "Assets/Data/Testing/t10k-images.idx3-ubyte";
    private const string TestLabels = "Assets/Data/Testing/t10k-labels.idx1-ubyte";
    ...
    public static IEnumerable<Dataset> ReadTestData()
    {
